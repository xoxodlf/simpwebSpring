...
public class ReportController {
	...
	public String reportSearchList(@RequestParam("searchType") String searchType,@RequestParam("keyword") String keyword,Model model) {
		if(keyword.equals("")) keyword="";
		
		logger.info(searchType + "    "+keyword);
		
		List<ReportDTO> list = service.searchList(searchType, keyword);
